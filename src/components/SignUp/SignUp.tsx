...
function Signup() {
    ...
    useEffect(() => {
        setUser({ ...user, localCart: JSON.parse(localCart) });
        setColors({
            ...
            <Form className="bg-light border shadow p-5 mb-4 rounded">
                <Form.Group className="row" controlId="formBasicEmail">
                    <Col>
                        ...
                        <Form.Control
                            className={`border-${colors.firstName} border-2`}
                            type="email"
                    ...
                    <Col>
                        ...
                        <Form.Control
                            className={`border-${colors.lastName} border-2`}
                            type="email"
                    ...
                    user?.pass !== user?.repeatPass ? (
                        <div className="text-center">
                            ...
                            {validationError?.email ? (
                                <Alert variant="warning" className="p-2 m-3">
                                    {validationError.email}
                                </Alert>
                            ) : null}
