...
function Cart(): ReactElement {
  ...
  const totalAmount = useSelector<StoreType, number>(
      ...
      <div className="container ml-auto mr-auto mt-4 bg-light border shadow p-5 rounded-lg m-3">
        <div className="container-fluid py-5">
          ...
          <p className="col-md-8 fs-4">
            It seems that your cart is totally empty. You can fix this by
            visiting our huge catalog, clicking on a product you love and adding
            a product by pressing the "Add to cart" button in the description!
          </p>
        </div>
      </div>
    );
        ...
        <div className="cartContainer p-2">
          ...
          <div className="cartGoToPaymentBtn">
            {userId === "guest" ? (
              ...
              <a className="btn btn-primary m-2" href="../payment">
                Go to Payement
              </a>
            )}
          </div>
